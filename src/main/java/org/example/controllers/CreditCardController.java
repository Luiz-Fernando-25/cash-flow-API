...
public class CreditCardController {
    ...
    @PostMapping
    public ResponseEntity<CreditCardResponseDTO> save(@RequestBody @Valid CreditCardRequestDTO creditCardRequestDTO) {
    ...
    @PutMapping()
    public ResponseEntity<Void> replace(@RequestBody CreditCardRequestDTO creditCardRequestDTO) {
